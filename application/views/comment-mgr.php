                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button data-id="<?php echo $comment -> comm_id; ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only am-delete"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
...
<script>
 ...
 $(function(){
   $('.am-delete').on('click', function(){
     var adminId =  $(this).data('id');
     if(confirm('确定是否删除记录，不可恢复!?')){
       location.href = 'welcome/delete_comment?comm_id='+adminId;
     }
   });
 });
</script>
